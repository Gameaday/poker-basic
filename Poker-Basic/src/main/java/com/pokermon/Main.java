...
//System.out.println(Arrays.toString(resultArray));
    ...
    /**
     * Reports statistics for all players in the game dynamically.
     * This method iterates through all players without hard-coded references.
     * 
     * @param list Array of players to report stats for
     */
...
//System.out.println("hand index: " + i);
    ...
    /**
     * Initializes the player list array dynamically based on the array size.
     * This method properly creates players without hard-coded references.
     * 
     * @param list Array to hold all players in the game
     */
    static void setupPlayersList(Player[] list) {
        // Initialize all player slots with new Player objects
        for (int i = 0; i < list.length; i++) {
            list[i] = new Player();
        }
    }
