...
class GameLogicBridgeAITest {
    ...
    fun `should not process AI by default`() {
        ...
        assertEquals(expectedPot, bridge.getCurrentPot(), 
    ...
    fun `should process AI opponents when enabled`() {
        ...
        assertTrue(bridge.getPlayerChips() < initialPlayerChips, 
        ...
        assertTrue(finalPot > initialPot + 50, 
    ...
    fun `should maintain game integrity with AI processing`() {
        ...
        assertTrue(totalAfter >= totalBefore - 500, // Allow some tolerance for game mechanics
