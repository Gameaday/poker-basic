...
object PersonalityManager {
     ...
     */
    fun assignMonsterToPlayer(playerName: String, monster: Monster? = null, personality: AIPersonality? = null) {
     ...
     */
    fun setCustomPersonality(playerName: String, personality: AIPersonality) {
