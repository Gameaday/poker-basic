...
open class Player(
    ...
    /**
     * Save player information for persistence (native-compatible).
     * Uses Kotlin-native approaches for file handling.
     */
    fun save() {
        try {
            // Native-compatible save - just log for now
            println("Saving player: $name, Chips: $chips, Hand Value: $handValue")
        } catch (e: Exception) {
