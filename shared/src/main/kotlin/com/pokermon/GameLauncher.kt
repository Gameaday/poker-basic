...
object GameLauncher {
    ...
    private fun showHelp() {
        val version = Version.getValidatedVersion()
        println(Version.APP_DISPLAY_NAME)
        println("Version: $version")
        println(Version.COPYRIGHT)
        println()
        println("USAGE:")
        println("  java -jar pokermon-$version.jar [OPTIONS]")
        println()
        println("DESCRIPTION:")
