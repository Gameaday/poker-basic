...
enum class GamePhase(
    ...
    PLAYER_ACTIONS(
        "Your turn",
        "Choose your action: call, raise, or fold",
        true,
        true,
        false,
        false,
    ...
    ROUND_END(
        "Round complete",
        "Round finished. Continue or end game?",
        true,
        false,
        false,
        true,
     ...
     */
    fun isSetupPhase(): Boolean = this == INITIALIZATION || this == PLAYER_SETUP || this == DECK_CREATION
