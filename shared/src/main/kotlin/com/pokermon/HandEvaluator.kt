...
object HandEvaluator {
    ...
    data class HandResult(
         ...
         */
        fun compareDetailed(other: HandResult): Int =
            when {
    ...
    private fun createFourOfAKindResult(
        rankCounts: Map<Int, Int>,
        sortedRanks: List<Int>,
    ): HandResult {
    ...
    private fun createFullHouseResult(
        rankCounts: Map<Int, Int>,
        sortedRanks: List<Int>,
    ): HandResult {
    ...
    private fun createThreeOfAKindResult(
        rankCounts: Map<Int, Int>,
        sortedRanks: List<Int>,
    ): HandResult {
        val tripRank = rankCounts.entries.first { it.value == 3 }.key
    ...
    private fun createTwoPairResult(
        rankCounts: Map<Int, Int>,
        sortedRanks: List<Int>,
    ): HandResult {
    ...
    private fun createOnePairResult(
        rankCounts: Map<Int, Int>,
        sortedRanks: List<Int>,
    ): HandResult {
        val pairRank = rankCounts.entries.first { it.value == 2 }.key
