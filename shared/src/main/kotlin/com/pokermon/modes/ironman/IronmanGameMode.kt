...
class IronmanGameMode(
    ...
    companion object {
        ...
        private val DIFFICULTY_MULTIPLIERS =
            mapOf(
                // Easy - 30% less risk
                1 to 0.7,
                ...
                // Hard - 30% more risk
                3 to 1.3,
                // Nightmare - 60% more risk
                4 to 1.6,
            )

        // Gacha rates (base rates)
        private val GACHA_RATES =
            mapOf(
        ...
        // Guaranteed rare after 50 pulls
        private const val PITY_TIMER_MAX = 50

        // Guaranteed legendary after 100 pulls
        private const val GUARANTEE_THRESHOLD = 100
    }
     ...
     */
    private fun adjustStakeByHand(
        baseStake: Int,
        handResult: HandEvaluator.HandResult,
    ): Int {
        val handStrengthFactor =
            when (handResult.handType) {
    ...
    private fun attemptRevive(): Boolean {
        ...
        return when (choice) {
            ...
            "2" -> {
                ...
                val hasFeather =
                    playerCollection.getOwnedMonsters().any {
